...
const KEYS = [
  { min: 360,  sun: 0xffc59a, sunI: 0.5,  elev: 0.06, hemi: 0.42, amb: 0.11, top: 0x24344f, bot: 0xc98a64, fog: 0xb89a86, lamp: 0.55 }, // 06:00 dawn
  { min: 540,  sun: 0xffe9cf, sunI: 1.7,  elev: 0.44, hemi: 0.78, amb: 0.17, top: 0x3f6aa3, bot: 0xbcc4cf, fog: 0xb9c2cc, lamp: 0.10 }, // 09:00 morning
  { min: 720,  sun: 0xfff4e2, sunI: 2.3,  elev: 0.98, hemi: 0.98, amb: 0.21, top: 0x3f74c0, bot: 0xcfe0ee, fog: 0xcdd9e6, lamp: 0.0  }, // 12:00 midday
  { min: 1020, sun: 0xffd6a0, sunI: 1.5,  elev: 0.40, hemi: 0.70, amb: 0.16, top: 0x37567f, bot: 0xd6a473, fog: 0xc6a486, lamp: 0.14 }, // 17:00 afternoon
  { min: 1140, sun: 0xff8a46, sunI: 0.75, elev: 0.05, hemi: 0.42, amb: 0.12, top: 0x2a3350, bot: 0xd07a45, fog: 0xb07a55, lamp: 0.5  }, // 19:00 dusk
  { min: 1290, sun: 0x9fb4e0, sunI: 0.06, elev:-0.10, hemi: 0.22, amb: 0.08, top: 0x0c1422, bot: 0x1b2740, fog: 0x16203a, lamp: 1.0  }, // 21:30 night
  { min: 1440, sun: 0x8fa6d8, sunI: 0.04, elev:-0.18, hemi: 0.18, amb: 0.07, top: 0x080f1a, bot: 0x131d31, fog: 0x101830, lamp: 1.0  }, // 24:00 deep night
];
