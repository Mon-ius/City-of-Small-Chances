...
SRC="$ROOT/tools/gen/source_batch18"
TMP="$ROOT/tools/gen/.tmp_batch18"
...
for src in \
  PROP_Vehicle_Scooter.png \
  PROP_Vehicle_Van.png \
  PROP_Vehicle_Tram.png \
  PROP_Job_Scanner.png \
  PROP_Job_MopBucket.png \
  PROP_Job_Boots.png
do
  if [[ ! -f "$SRC/$src" ]]; then
...
process_cutout PROP_Vehicle_Scooter
process_cutout PROP_Vehicle_Van
process_cutout PROP_Vehicle_Tram
process_cutout PROP_Job_Scanner
process_cutout PROP_Job_MopBucket
process_cutout PROP_Job_Boots
