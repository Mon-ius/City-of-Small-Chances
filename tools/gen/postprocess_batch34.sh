...
TMP="${TMPDIR:-/tmp}/harbour_batch34_postprocess"
SOURCE_DIR="${SOURCE_DIR:-${1:-$ROOT/tools/gen/source_batch34}}"
MAGICK="${MAGICK:-magick}"
CHROMA="${CODEX_HOME:-$HOME/.codex}/skills/.system/imagegen/scripts/remove_chroma_key.py"

NAMES=(Blacksmith Baker Tinker Mother Soldier Coalman)
TARGET_FEET_ROW=976
...
names = ["Blacksmith", "Baker", "Tinker", "Mother", "Soldier", "Coalman"]
notes = {
    "Blacksmith": "broad smith in scorched leather apron holding hammer and tongs; no legible text",
    "Baker": "white-capped baker in white apron carrying a tray of bread loaves; no legible text",
    "Tinker": "weathered tinker with wood-framed pack hung with pots, pans, and kettles; no legible text",
    "Mother": "young harbour mother in shawl cradling a swaddled infant; no legible text",
    "Soldier": "serving soldier in red tunic and tall cap holding a rifle at attention; no legible text",
    "Coalman": "coal-blackened coalman bent under a black coal sack with fantail hat; no legible text",
}
failed = False
tiles = []
...
sheet_path = tmp / "batch34_grey_check.png"
...
"$MAGICK" "$OUT"/CHAR_Harbour_Citizen_{Blacksmith,Baker,Tinker,Mother,Soldier,Coalman}_albedo.png \
  -background '#808080' -alpha remove -alpha off +append "$TMP/batch34_strip_on_grey.png"

identify -format '%f %wx%h %b\n' "$OUT"/CHAR_Harbour_Citizen_{Blacksmith,Baker,Tinker,Mother,Soldier,Coalman}_albedo.png
echo "Grey strip check: $TMP/batch34_strip_on_grey.png"
