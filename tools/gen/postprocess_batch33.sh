...
TMP="${TMPDIR:-/tmp}/harbour_batch33_postprocess"
SOURCE_DIR="${SOURCE_DIR:-${1:-$ROOT/tools/gen/source_batch33}}"
MAGICK="${MAGICK:-magick}"
CHROMA="${CODEX_HOME:-$HOME/.codex}/skills/.system/imagegen/scripts/remove_chroma_key.py"

NAMES=(Priest Doctor Lamplighter Urchin Innkeeper Ferryman)
TARGET_FEET_ROW=976
...
names = ["Priest", "Doctor", "Lamplighter", "Urchin", "Innkeeper", "Ferryman"]
notes = {
    "Priest": "black-cassock priest with white clerical collar and small prayer book; no legible text",
    "Doctor": "bowler-hatted doctor in dark frock coat carrying a black Gladstone medical bag; no legible text",
    "Lamplighter": "working lamplighter with cap, waistcoat, and tall brass lamp-lighting pole; no legible text",
    "Urchin": "barefoot ragged boy in oversized cap and patched too-big clothes; no legible text",
    "Innkeeper": "stout publican in cream/leather apron holding a pewter tankard; no legible text",
    "Ferryman": "weathered boatman in dark jersey and knit cap carrying a long wooden oar; no legible text",
}
failed = False
tiles = []
...
sheet_path = tmp / "batch33_grey_check.png"
...
"$MAGICK" "$OUT"/CHAR_Harbour_Citizen_{Priest,Doctor,Lamplighter,Urchin,Innkeeper,Ferryman}_albedo.png \
  -background '#808080' -alpha remove -alpha off +append "$TMP/batch33_strip_on_grey.png"

identify -format '%f %wx%h %b\n' "$OUT"/CHAR_Harbour_Citizen_{Priest,Doctor,Lamplighter,Urchin,Innkeeper,Ferryman}_albedo.png
echo "Grey strip check: $TMP/batch33_strip_on_grey.png"
